...
export const Statistics: React.FC = () => {
    ...
    const { totalCourses, totalSections, totalThemes, totalTasks } = getTotalStats();
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="p-6 max-w-7xl mx-auto">
                ...
                {systemStats && (
                    <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                        <h3 className="text-xl font-semibold text-gray-900 mb-4">Системная статистика</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium text-gray-600">Курсы в системе</span>
                                    <span className="text-lg font-bold text-gray-900">{systemStats.coursesCount}</span>
                                </div>
                            </div>
                            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium text-gray-600">Секции в системе</span>
                                    <span className="text-lg font-bold text-gray-900">{systemStats.sectionsCount}</span>
                                </div>
                            </div>
                            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium text-gray-600">Темы в системе</span>
                                    <span className="text-lg font-bold text-gray-900">{systemStats.themesCount}</span>
                                </div>
                            </div>
                            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium text-gray-600">Задачи в системе</span>
                                    <span className="text-lg font-bold text-gray-900">{systemStats.tasksCount}</span>
                                </div>
                            </div>
                        </div>
                    </div>
